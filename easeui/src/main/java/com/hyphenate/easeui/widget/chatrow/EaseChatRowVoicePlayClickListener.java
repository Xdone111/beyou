...
public class EaseChatRowVoicePlayClickListener implements View.OnClickListener {
	...
	private void showAnimation() {
		...
		if (message.direct() == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(com.hyphenate.easeui.R.drawable.voice_from_icon);
		} else {
			voiceIconView.setImageResource(com.hyphenate.easeui.R.drawable.voice_to_icon);
		}
