...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void initView() {
        onInflateView();
        timeStampView = (TextView) findViewById(com.hyphenate.easeui.R.id.timestamp);
        userAvatarView = (ImageView) findViewById(com.hyphenate.easeui.R.id.iv_userhead);
        bubbleLayout = findViewById(com.hyphenate.easeui.R.id.bubble);
        usernickView = (TextView) findViewById(com.hyphenate.easeui.R.id.tv_userid);

        progressBar = (ProgressBar) findViewById(com.hyphenate.easeui.R.id.progress_bar);
        statusView = (ImageView) findViewById(com.hyphenate.easeui.R.id.msg_status);
        ackedView = (TextView) findViewById(com.hyphenate.easeui.R.id.tv_ack);
        deliveredView = (TextView) findViewById(com.hyphenate.easeui.R.id.tv_delivered);
        ...
        activity.runOnUiThread(new Runnable() {
            public void run() {
                if (message.status() == EMMessage.Status.FAIL) {
                    Toast.makeText(activity,activity.getString(com.hyphenate.easeui.R.string.send_fail) + activity.getString(com.hyphenate.easeui.R.string.connect_failuer_toast), Toast.LENGTH_SHORT).show();
                }
        ...
        activity.runOnUiThread(new Runnable() {
            public void run() {
                if (errorCode == EMError.MESSAGE_INCLUDE_ILLEGAL_CONTENT) {
                    Toast.makeText(activity,activity.getString(com.hyphenate.easeui.R.string.send_fail) + activity.getString(com.hyphenate.easeui.R.string.error_send_invalid_content), Toast.LENGTH_SHORT).show();
                } else if (errorCode == EMError.GROUP_NOT_JOINED) {
                    Toast.makeText(activity,activity.getString(com.hyphenate.easeui.R.string.send_fail) + activity.getString(com.hyphenate.easeui.R.string.error_send_not_in_the_group), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(activity,activity.getString(com.hyphenate.easeui.R.string.send_fail) + activity.getString(com.hyphenate.easeui.R.string.connect_failuer_toast), Toast.LENGTH_SHORT).show();
                }
                onUpdateView();
