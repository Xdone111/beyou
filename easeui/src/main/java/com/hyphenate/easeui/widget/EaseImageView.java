...
public class EaseImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, com.hyphenate.easeui.R.styleable.EaseImageView);
            borderColor = array.getColor(com.hyphenate.easeui.R.styleable.EaseImageView_ease_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(com.hyphenate.easeui.R.styleable.EaseImageView_ease_border_width, borderWidth);
            pressAlpha = array.getInteger(com.hyphenate.easeui.R.styleable.EaseImageView_ease_press_alpha, pressAlpha);
            pressColor = array.getColor(com.hyphenate.easeui.R.styleable.EaseImageView_ease_press_color, pressColor);
            radius = array.getDimensionPixelOffset(com.hyphenate.easeui.R.styleable.EaseImageView_ease_radius, radius);
            shapeType = array.getInteger(com.hyphenate.easeui.R.styleable.EaseImageView_ease_shape_type, shapeType);
            array.recycle();
        }
