...
public class EaseChatRowLocation extends EaseChatRow{
    ...
    protected void onInflateView() {
        inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
                com.hyphenate.easeui.R.layout.ease_row_received_location : com.hyphenate.easeui.R.layout.ease_row_sent_location, this);
    }

    @Override
    protected void onFindViewById() {
    	locationView = (TextView) findViewById(com.hyphenate.easeui.R.id.tv_location);
    }
