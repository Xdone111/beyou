...
public class EaseAlertDialog extends Dialog {
	...
	public EaseAlertDialog(Context context, int msgId) {
		super(context);
		this.title = context.getResources().getString(com.hyphenate.easeui.R.string.prompt);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.hyphenate.easeui.R.layout.ease_alert_dialog);
		
		Button cancel = (Button)findViewById(com.hyphenate.easeui.R.id.btn_cancel);
		Button ok = (Button)findViewById(com.hyphenate.easeui.R.id.btn_ok);
		TextView titleView = (TextView) findViewById(com.hyphenate.easeui.R.id.title);
		setTitle(title);
		
		View.OnClickListener listener = new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				if (view.getId() == com.hyphenate.easeui.R.id.btn_ok) {
					onOk(view);
				} else if (view.getId() == com.hyphenate.easeui.R.id.btn_cancel) {
					onCancel(view);
				}
			}
		};
		...
		if (msg != null)
		    ((TextView)findViewById(com.hyphenate.easeui.R.id.alert_message)).setText(msg);
	}
