...
import byou.yadun.wallet.Chat.BaseActivity;
import byou.yadun.wallet.Chat.ChatActivity;
import byou.yadun.wallet.Chat.ContactListFragment;
import byou.yadun.wallet.Chat.FragmentChat;
import byou.yadun.wallet.Chat.GroupsActivity;
...
import byou.yadun.wallet.runtimepermissions.PermissionsResultAction;
...
public class MainActivity extends BaseActivity {
    ...
    private FragmentWallet1 homeFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null &&
            ...
            ByHelper.getInstance().logout(false, null);
            finish();
        ...
        conversationListFragment = new FragmentChat();
        contactListFragment = new ContactListFragment();
        homeFragment = new FragmentWallet1();
        FragmentUser Fragmentuser = new FragmentUser();
        FragmentShop Fragmentshop = new FragmentShop();
        TestMapFragment testMapActivity = new TestMapFragment();
        fragments = new Fragment[]{conversationListFragment, homeFragment, contactListFragment, Fragmentuser, testMapActivity};

        getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, conversationListFragment).add(R.id.fragment_container, homeFragment)
                .add(R.id.fragment_container, contactListFragment).add(R.id.fragment_container, Fragmentshop).hide(contactListFragment).hide(homeFragment).hide(Fragmentshop).show(conversationListFragment)
                .commit();

        //register broadcast receiver to receive the change of group from ByHelper
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        ...
        mTabs[4] = (Button) findViewById(R.id.btn_shop);
        // select first tab
    ...
    EMMessageListener messageListener = new EMMessageListener() {
        ...
        public void onMessageReceived(List<EMMessage> messages) {
            ...
            for (EMMessage message : messages) {
                ByHelper.getInstance().getNotifier().onNewMsg(message);
            }
            refreshUIWithMessage();
        }
    ...
    protected void onResume() {
        ...
        // background
        ByHelper sdkHelper = ByHelper.getInstance();
    ...
    private FragmentChat conversationListFragment;
    ...
    private void registerInternalDebugReceiver() {
        internalDebugReceiver = new BroadcastReceiver() {
            ...
            @Override
            public void onReceive(Context context, Intent intent) {
                ByHelper.getInstance().logout(false, new EMCallBack() {
    ...
    public void startconver() {
        onTabClicked((Button) findViewById(R.id.btn_address_list));
    }
}
