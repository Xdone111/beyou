package byou.yadun.wallet.adapter.MyAdapter;
...
public abstract class CommonAdapter<T> extends BaseAdapter {
	...
	public View getView(final int position, View convertView, final ViewGroup parent) {
		ViewHolder viewHolder = getAdapterHelper(position, convertView, parent);
	...
	protected ViewHolder getAdapterHelper(int position, View convertView, ViewGroup parent) {
		return ViewHolder.get(context, convertView, parent, layoutResId, position);
	}
