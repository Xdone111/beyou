...
import byou.yadun.wallet.wallet.CaptureActivity;

/**
 * 聊天首页
 */
public class FragmentChat extends EaseConversationListFragment {
    private TextView errorText;

    @Override
    protected void initView() {
        super.initView();
        View errorView = (LinearLayout) View.inflate(getActivity(), R.layout.fragment_chat, null);
...
//                startActivity(new Intent(getActivity(), AddContactActivity.class));
                com.hyphenate.util.NetUtils.hasDataConnection(getActivity());
            }
        });
        // 进入通讯录界面
...
//                    Toast.makeText(getActivity(), "扫一扫"+item.getGroupId(), Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getActivity(), CaptureActivity.class);
                    intent.putExtra("address", "saoyisao");
                    startActivity(intent);
                } else if (item.getTitle().equals(getResources().getString(R.string.start_chat))) {
//                    Toast.makeText(getActivity(), "发起聊天"+item.getItemId(), Toast.LENGTH_SHORT).show();
                    MainActivity mainActivity = (MainActivity) getActivity();
                    mainActivity.startconver();
                }else if (item.getTitle().equals(getResources().getString(R.string.add_friend))){
                    startActivity(new Intent(getActivity(), AddContactActivity.class));
                } else {
//                    Toast.makeText(getActivity(), "我的二维码"+item.getItemId(), Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getActivity(), MyCodeActivity.class);
                    intent.putExtra("mycode", new PreferenceUtil().getUser("account").trim());
                    startActivity(intent);
                }
                return false;
            }
