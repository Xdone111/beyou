...
public class EaseBaiduMapActivity extends EaseBaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.hyphenate.easeui.R.layout.ease_activity_baidumap);
		mMapView = (MapView) findViewById(com.hyphenate.easeui.R.id.bmapView);
		sendButton = (Button) findViewById(com.hyphenate.easeui.R.id.btn_location_send);
