...
public class AutoListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case DONE:
                ...
                lvHeaderProgressBar.setVisibility(View.GONE);
                lvHeaderArrowIv.clearAnimation();
                lvHeaderArrowIv.setImageResource(R.drawable.loadmore_progress);
                lvHeaderTipsTv.setText("下拉刷新");
                lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
                break;
        }
    ...
    public void setonRefreshListener(OnRefreshListener refreshListener) {
        this.refreshListener = (SwipeRefreshLayout.OnRefreshListener) refreshListener;
        isRefreshable = true;
    }
    ...
    public void setAdapter(ReceiveAdapter2 adapter) {
        lvHeaderLastUpdatedTv.setText("最近更新:" + new Date().toLocaleString());
