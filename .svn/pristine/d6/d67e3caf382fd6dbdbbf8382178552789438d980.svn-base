package byou.yadun.wallet.manager;
...
import byou.yadun.wallet.utils.ImageUtils;
...
public class HttpManager {
  ...
  // public static final String BASE_URL = "http://192.168.0.105/";
   public static final String BASE_URL="http://api.ydchain.cc/";
    private HttpManager() {
        mOkHttpClient = new OkHttpClient();
        mOkHttpClient.setCookieHandler(new CookieManager(null, CookiePolicy.ACCEPT_ORIGINAL_SERVER));
        mOkHttpClient.setReadTimeout(15000, TimeUnit.MILLISECONDS);
        mOkHttpClient.setWriteTimeout(15000, TimeUnit.MILLISECONDS);
    ...
    private HttpManager(long timeOut){
        mOkHttpClient = new OkHttpClient();
    ...
    private static HttpManager getInstance(long timeOut){
        if (mInstanceWithTime == null) {
            synchronized (HttpManager.class) {
                if (mInstanceWithTime == null) {
                    mInstanceWithTime = new HttpManager(timeOut);
                }
            }
        }
    ...
    public static void getAsync(String url, ResultCallback callback) {
        getInstance().getGetDelegate().getAsync(url, callback, null);
    }

    public static void getAsync(String url, ResultCallback callback, Object tag) {
        getInstance().getGetDelegate().getAsync(url, callback, tag);
    }

    /**
     * ============POST start===============
     */
    public static void postAsync(String url, Param[] params, final ResultCallback callback) {
    ...
    public static void postAsync(String url, String bodyStr, final ResultCallback callback) {
        getInstance().getPostDelegate().postAsync(url, bodyStr, callback, null);
    }

    public static void postAsync(long timeOut,String url, String bodyStr, final ResultCallback callback) {
        getInstance(timeOut).getPostDelegate().postAsync(url, bodyStr, callback, null);
    }
    ...
    public static void postAsync(String url, String bodyStr, final ResultCallback callback, Object tag) {
//        LogManager.d("UI--->postAsync: " + url + bodyStr);
        getInstance().getPostDelegate().postAsync(url, bodyStr, callback, tag);
    }

    public static void postAsync(String url, byte[] bodyData, final ResultCallback callback, Object tag) {
//        LogManager.d("UI--->postAsync: post byte data to " + url);
        getInstance().getPostDelegate().postAsync(url, bodyData, callback, tag);
    }
    ...
    public static void cancelTag(Object tag) {
        getInstance().innerCancelTag(tag);
    }

    private void innerCancelTag(Object tag) {
    ...
    public class PostDelegate {
        ...
        public void postAsync(String url, Map<String, String> params, final ResultCallback callback) {
            postAsync(url, params, callback, null);
        }
        ...
        public void postAsync(String url, Param[] params, final ResultCallback callback) {
            postAsync(url, params, callback, null);
        }
         ...
         * 直接将bodyStr以写入请求体
         */
        public void postAsync(String url, String bodyStr, final ResultCallback callback) {
            postAsync(url, bodyStr, callback, null);
        }

        public void postAsync(String url, String bodyStr, final ResultCallback callback, Object tag) {
         ...
         * 直接将bodyBytes以写入请求体
         */
        public void postAsync(String url, byte[] bodyBytes, final ResultCallback callback) {
            postAsync(url, bodyBytes, callback, null);
        }

        public void postAsync(String url, byte[] bodyBytes, final ResultCallback callback, Object tag) {
         ...
         * 直接将bodyFile以写入请求体
         */
        public void postAsync(String url, File bodyFile, final ResultCallback callback) {
            postAsync(url, bodyFile, callback, null);
        }

        public void postAsync(String url, File bodyFile, final ResultCallback callback, Object tag) {
    ...
    public class GetDelegate {
        ...
        public void getAsync(String url, final ResultCallback callback, Object tag) {
            final Request request = buildGetRequest(url, tag);
    ...
    public class UploadDelegate {
         ...
         */
        public void postAsync(String url, String fileKey, File file, ResultCallback callback, Object tag) throws IOException {
            postAsync(url, new String[]{fileKey}, new File[]{file}, null, callback, tag);
        }
