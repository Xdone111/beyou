...
public class EaseChatMessageList extends RelativeLayout{
    ...
    private void init(Context context){
        ...
        LayoutInflater.from(context).inflate(com.hyphenate.easeui.R.layout.ease_chat_message_list, this);
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(com.hyphenate.easeui.R.id.chat_swipe_layout);
    ...
    protected void parseStyle(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, com.hyphenate.easeui.R.styleable.EaseChatMessageList);
        EaseMessageListItemStyle.Builder builder = new EaseMessageListItemStyle.Builder();
        builder.showAvatar(ta.getBoolean(com.hyphenate.easeui.R.styleable.EaseChatMessageList_msgListShowUserAvatar, true))
                .showUserNick(ta.getBoolean(com.hyphenate.easeui.R.styleable.EaseChatMessageList_msgListShowUserNick, false))
                .myBubbleBg(ta.getDrawable(com.hyphenate.easeui.R.styleable.EaseChatMessageList_msgListMyBubbleBackground))
                .otherBuddleBg(ta.getDrawable(com.hyphenate.easeui.R.styleable.EaseChatMessageList_msgListMyBubbleBackground));
