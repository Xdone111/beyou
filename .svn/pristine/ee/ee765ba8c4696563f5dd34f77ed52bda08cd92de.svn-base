...
import byou.yadun.wallet.BuildConfig;
import byou.yadun.wallet.R;
import byou.yadun.wallet.domain.VideoEntity;
import byou.yadun.wallet.video.util.ImageCache;
import byou.yadun.wallet.video.util.ImageResizer;
import byou.yadun.wallet.video.util.Utils;
import byou.yadun.wallet.widget.RecyclingImageView;
