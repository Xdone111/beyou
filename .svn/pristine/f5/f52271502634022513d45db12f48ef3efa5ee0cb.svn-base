    ...
    protected void onSetUpView() {
        ...
        if (EaseChatRowVoicePlayClickListener.playMsgId != null
            ...
            if (message.direct() == EMMessage.Direct.RECEIVE) {
                voiceImageView.setImageResource(com.hyphenate.easeui.R.drawable.voice_from_icon);
            } else {
                voiceImageView.setImageResource(com.hyphenate.easeui.R.drawable.voice_to_icon);
            }
