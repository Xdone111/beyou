 ...
 */
public class RGBLuminanceSource1 extends LuminanceSource {
	private final byte[] luminances;

	public RGBLuminanceSource1(Bitmap bitmap) {
	...
	public RGBLuminanceSource1(String path) throws FileNotFoundException {
