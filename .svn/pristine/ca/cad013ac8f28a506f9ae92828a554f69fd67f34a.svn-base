...
import byou.yadun.wallet.wallet.FastPayActivity;
import byou.yadun.wallet.wallet.ShowSuccessActivity;

/**
 *红包确认支付
 */
public class RedBagPaymentActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnSurePay:
                if(NetUtils.isNetworkAvailable(RedBagPaymentActivity.this)){
                    if(mPayPs!=null){
        ...
        HttpManager.postAsync(HttpManager.BASE_URL + "api.php/user/upmyzc.html?", parmas, new HttpManager.ResultCallback<CommonRespone>() {
            ...
            public void onResponse(CommonRespone response) {
                if(response.getCode().equals("1")){
                    ...
                    finish();
                    startActivity(new Intent(RedBagPaymentActivity.this,ShowSuccessActivity.class));
                }else{
