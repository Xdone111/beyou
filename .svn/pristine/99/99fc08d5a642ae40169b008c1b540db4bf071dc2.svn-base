...
public class BeautysActivity extends BaseActivity {
    ...
    private void initEvent() {
        ...
        mFoodsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(BeautysActivity.this,FoodsDetailsActivity.class);
            ...
            public void onResponse(ShopInfo response) {
                if(response.getCode()==1){
                    if(response.getData().size()==0){
                        ...
                        mShopAdapter = new ShopAdapter(BeautysActivity.this,mList);
