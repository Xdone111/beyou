...
public class EaseTitleBar extends RelativeLayout{
    ...
    private void init(Context context, AttributeSet attrs){
        LayoutInflater.from(context).inflate(com.hyphenate.easeui.R.layout.ease_widget_title_bar, this);
        leftLayout = (RelativeLayout) findViewById(com.hyphenate.easeui.R.id.left_layout);
        leftImage = (ImageView) findViewById(com.hyphenate.easeui.R.id.left_image);
        rightLayout = (RelativeLayout) findViewById(com.hyphenate.easeui.R.id.right_layout);
        rightImage = (ImageView) findViewById(com.hyphenate.easeui.R.id.right_image);
        titleView = (TextView) findViewById(com.hyphenate.easeui.R.id.title);
        titleLayout = (RelativeLayout) findViewById(com.hyphenate.easeui.R.id.root);
