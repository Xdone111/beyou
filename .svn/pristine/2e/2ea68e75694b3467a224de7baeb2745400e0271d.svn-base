...
public class ForgetPasswordActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(byou.yadun.wallet.R.layout.activity_forgetps);
        initView();
        initEvent();
    }
    ...
    private void initView() {
        ...
        mTxtTitle.setText(getResources().getString(byou.yadun.wallet.R.string.forget_name));
    ...
    public void amendPassword(){
        ...
        if(mEdtPasswordAgain.getText().toString().isEmpty()){
            showToast(getResources().getString(byou.yadun.wallet.R.string.forget_ps_null));
            return;
        }
        ...
        HttpManager.postAsync(HttpManager.BASE_URL + "api.php/base/getpassword.html?", parmas, new HttpManager.ResultCallback<CommonRespone>() {
            @Override
