...
public class KtvsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(byou.yadun.wallet.R.layout.activity_foods);
        initView();
        initData();
        initEvent();
    }
    ...
    private void initView() {
        ...
        mTxtTitle.setText("KTV");
        mFoodsListView = (XListView) findViewById(byou.yadun.wallet.R.id.foodsListView);
        mFoodsListView.setPullRefreshEnable(false);
        mTxtNoShop = (TextView) findViewById(byou.yadun.wallet.R.id.noShop);
    ...
    private void initEvent() {
        ...
        mFoodsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(KtvsActivity.this,FoodsDetailsActivity.class);
            ...
            public void onResponse(ShopInfo response) {
                if(response.getCode()==1){
                    if(response.getData().size()==0){
                        ...
                        mShopAdapter = new ShopAdapter(KtvsActivity.this,mList);
